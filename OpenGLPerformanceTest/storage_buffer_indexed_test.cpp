...
"#define EndUniformBlock(name_) }; layout(std140, binding=0) buffer name_ { name_##_data_s name_##_data [] ; };\n"
...
void storage_buffer_indexed_test::pre_init( const char* vertex_shader_, const char* fragment_shader_ ) {
