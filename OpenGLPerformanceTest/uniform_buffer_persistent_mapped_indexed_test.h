...
class uniform_buffer_persistent_mapped_indexed_test : public opengl_test<uniform_buffer_persistent_mapped_indexed_test> {
...
public:
    uniform_buffer_persistent_mapped_indexed_test();
    ~uniform_buffer_persistent_mapped_indexed_test();
};
